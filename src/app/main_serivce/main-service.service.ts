...
export class MainServiceService {
  ...
  voided_appointment(): void{
    this.http.post('/api/voided_parse', {}).subscribe(async (data: any) => {
  ...
  getAllRoom(serviceSelectedCall: string, roomSelectedCall: string): Observable<any>{
    return this.http.post<any>('/api/getRoomAll', { serviceSelectedCall: serviceSelectedCall, roomSelectedCall: roomSelectedCall });
  }
