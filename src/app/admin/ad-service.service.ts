...
export class AdServiceService {
  ...
  acceptDecline(id: string, condition: boolean, name_column: string, firstFirst: boolean): Observable<any>{
    return this.http.post<any>('/api/acceptDecline_Appointments', { datas: { id: id, condition: String(condition), name_column: name_column, firstFirst: firstFirst } });
  }
  ...
  deleteEvent(id: string): Observable<any>{
    return this.http.post<any>('/api/deleteEvent', { datas: { id: id } });
  }
  ...
  accept_declineReservation(room_id: string, email_id: string, confirmation: string, condition: boolean): Observable<any>{
    return this.http.post<any>('/api/A-D_Request', { room_id: room_id,  email_id: email_id, confirmation_date: confirmation, condition: condition});
  }

  deleteReservation(room_id: string, email_id: string): Observable<any>{
    return this.http.post<any>('/api/deleteReservation', { room_id: room_id,  email_id: email_id });
  }

  deleteReservation_Final(room_id: string, email_id: string): Observable<any>{
    return this.http.post<any>('/api/deleteReservation_final', { room_id: room_id,  email_id: email_id });
  }
} 
